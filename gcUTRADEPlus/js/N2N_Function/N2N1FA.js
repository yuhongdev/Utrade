	...
	function _generateWindow(type, args){
		...
		var imagePanel = new Ext.Panel({
			   ...
			   items: 
				   [{  width:"100%",
				       border: false,
					   html:'<div style="float:left;">' + languageFormat.getLanguage(30806, '<B>Important Notice:</B><br><br>We noticed that you have yet to register or link your OneKey Token for 2FA (2nd Factor Authentication).<br><br>As your online trading security is our top priority, please proceed to apply for the OneKey device now if you have not done so.<br><br>') + '<p align=center><a href="https://portal.assurity.sg/naf-web/public/index.do" target="_blank"><img style="height:23px" src="'+iconRegisterNowFA+'" /></p></div>'}]
