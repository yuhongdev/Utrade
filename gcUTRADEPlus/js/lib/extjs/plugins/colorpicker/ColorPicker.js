...
Ext.define('Ext.ux.colorpicker.ColorPicker', {
    ...
    items: [{
            ...
            items: [{
                    ...
                    items: [{
                            ...
                            defaultType: 'container',
                            style: "padding-left: 70px;padding-top:10px;",
                            items: [{
                                    style: "background-color:#20272F;width: 40px;",
                                    xtype: 'button',
                                    text: 'OK',
                                    itemId: 'bSelect'
    ...
    setColor: function(c) {
        ...
        if (me.rendered) {
            ...
            me.hexaChange();
            var rgbarr = me.hexToRgb(c);
            var rgb = {r: rgbarr[0],
                g: rgbarr[1],
                b: rgbarr[2]};
            var hsb = me.RGBToHSB(rgb);
            me.moveHuePicker(me.toY(hsb));
            me.down('#iHexa').setValue(c);
    ...
    toY: function(hsb) {
        ...
        return  parseFloat(181 - 181 * hsb.h / 360);
    ...
    hueClick: function(event, el) {
        ...
        this.fireEvent('click', this, me.down('#iHexa').getValue());
    },
    ...
    moveHuePicker: function(y) {
        ...
        hp.setXY(hp.getLeft(), me.down('#cHue').getEl().getTop() + y - 7, true);
    ...
    moveRgbPicker: function(x, y) {
        ...
        hsv.v = me.getVal(y);
        me.down('#rgbPicker').getEl().setXY(cRgb.getLeft() + x - 7, cRgb.getTop() + y - 7, true);
        me.updateColor();
    },
    updateColor: function() {
        ...
        if (me.updateMode != 'click') {
            ...
            hp.setXY(hp.getLeft(), cHue.getTop() + me.getHPos(me.down('#iHue').getValue()) - 7, true);
            me.down('#rgbPicker').getEl().setXY(cRgb.getLeft() + me.getSPos(me.down('#iSat').getValue() / 100) - 7,
