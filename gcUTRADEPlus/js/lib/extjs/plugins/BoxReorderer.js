...
Ext.define('Ext.ux.BoxReorderer', {
    ...
    doSwap: function(newIndex) {
        ...
        var cookieMenuSetting = '';
        var savedMenuItemsPos = new Array();
        for (var i = 0; i < items.length; i++) {
        	savedMenuItemsPos.push(items.items[i].id);
        }

        cookieMenuSetting = savedMenuItemsPos.join(',');
        cookies.createCookie(loginId + '_MenuRowSettings', cookieMenuSetting, 1800);
