...
//  	}
    ...
    editForm: function(side) {
        ...
        // bug - v1.3.14.8
        var totalValue = calculationOfPortFolioDetail(parseFloat(store.get('quantity').replace(",", "")),
                parseFloat(store.get('price').replace(",", "")),
                parseFloat(store.get('transactionFee').replace(",", "")),
                store.get('side'));
        ...
        var newPanel = new Ext.form.Panel({
            ...
            items: [
                ...
                Ext.create('widget.numericfield', {
                    ...
                    thousandSeparator: ',',
                    decimalPrecision: 3,
                    value: store.data['quantity'].replace(",", "")
                }),
                {
                    xtype: 'numericfield',
                    ...
                    decimalPrecision: 3,
                    allowNegative: false,
                    value: store.data['price'].replace(",", ""),
                ...
                },
                {
                    ...
                    thousandSeparator: ',',
                    decimalPrecision: 3,
                    value: store.data['transactionFee'].replace(",", ""),
                    fieldStyle: 'text-align:right',
                    listeners: {
                        keyup: function() {
                            panel.calculateTotal();
