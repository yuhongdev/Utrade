Ext.define('TCPlus.view.other.exchangeRate', {
    ...
    initComponent: function() {
        ...
        me.labelEffDateTime = new Ext.form.field.Display({
            ...
            width: '100%',
            labelSeparator: ':&nbsp',
            style: global_personalizationTheme.indexOf("black") != -1 ? "display:inline-block;padding-left: 5px;" : "display:inline-block;padding-left:15px;",
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    border: false,
                                    style: global_personalizationTheme.indexOf("black") != -1 ? "padding-top:5px;cursor:pointer;" : "padding-top:5px;cursor:pointer;",
                                    html: "<div id='refreshcurrencytable'><img src='" + iconRefreshLimit + "' style='margin-top:2px;'/></div>",
                                    listeners: {
                                        afterrender: function() {
                                            Ext.get("refreshcurrencytable").on("click", function() {
                                                me.callCurrencyTable();
                                                var accountName = (me.comboAcc.getValue()).split(global_AccountSeparator); // #account list separator ('-')
    ...
    callCUT: function() {
        var me = this;
        var accCombo = (me.comboAcc.getValue()).split(global_AccountSeparator);
    ...
    getFlag: function(val) {
        var imgAdr = "";
        var img = "";
        var imgfd = "images/fxConversion/";
        var space = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        switch (val) {
            case "AUD":
                imgAdr = imgfd + "flag_aud.png";
                break;
            case "CAD":
                imgAdr = imgfd + "flag_cad.png";
                break;
            case "NZD":
                imgAdr = imgfd + "flag_nz.png";
                break;
            case "USD":
                imgAdr = imgfd + "flag_us.png";
                break;
            case "SGD":
                imgAdr = imgfd + "flag_sgd.png";
                break;
            case "EUR":
                imgAdr = imgfd + "flag_eur.png";
                break;
            case "GBP":
                imgAdr = imgfd + "flag_uk.png";
                break;
            case "JPY":
                imgAdr = imgfd + "flag_jp.png";
                break;
            case "CHF":
                imgAdr = imgfd + "flag_swl.png";
                break;
            case "HKD":
                imgAdr = imgfd + "flag_hkd.png";
                break;
            case "CNH":
                imgAdr = imgfd + "flag_cn.png";
                break;
        }

        img = "<img src='" + imgAdr + "'/>" + space;
        return [img, imgAdr];
    },
    ...
    getFXConversion: function(rec) {
        ...
        me.textCurr1 = new Ext.form.NumberField({
            ...
            allowDecimals: true,
            style: "border-top: none; border-bottom: none; border-right: none;text-align:right;padding-right:5px;",
        ...
        me.comboCurr1 = new Ext.form.ComboBox({
            ...
            triggerAction: 'all',
            tpl: '<tpl for="."><li class="x-boundlist-item"><div style="float:left;"><img src="{address}"/></div><div style="float:left;padding-top:5px;">&nbsp;&nbsp;{value}</div><li><div style="clear:both;"></div></tpl>',
            mode: 'local',
            editable: false,
            displayField: "value",
            width: "100%",
        ...
        me.comboCurr2 = new Ext.form.ComboBox({
            ...
            store: new Ext.data.ArrayStore({
                fields: ["value", "address"],
                // data: [["SGD", "SGD", me.getFlag("SGD")[1]], ["USD", "USD", me.getFlag("USD")[1]], ["HKD", "HKD", me.getFlag("HKD")[1]]]
                data: me.arrCurr,
                listeners: {
                    load: function(store) {
                        var hits = {};
        ...
        me.winFXConversion = new Ext.Window({
            title: "<img src='images/fxConversion/fxconversion.png'/>",
            width: 420,
            cls: "fxconversion",
            plain: true,
            layout: 'fit',
                    ...
                    items: [{
                            ...
                            items: [{
                                    ...
                                    items: [me.comboCurr1, {
                                            ...
                                            border: true,
                                            height: 20,
                                            bodyStyle: "background-color:#fff;background-image: url('images/text-bg.gif');",
                                            items: [
                                                me.labelCurr1,
                                                me.textCurr1
                                            ]
                                    ...
                                    items: [{
                                            ...
                                            html: '<div id="interchange"><img height="21" src="' + iconFXFlipIcon + '"/></div>',
                                            listeners: {
                                                afterrender: function() {
    ...
    submit: function() {
        try {
            ...
            var acc = me.comboAcc.getValue().split(global_AccountSeparator);
    ...
    setIconCombo: function(comp, val) {
        var me = this;
        comp.setFieldStyle('background-image: url("' + me.getFlag(val)[1] + '"); background-size:20px;background-repeat:no-repeat;background-position: 2px;padding-left: 25px;');
    },
    ...
    confirmation: function() {
        var me = this;
        var stringContent = "<div style='clear:both;padding-top:5px;padding-left:5px;'>" + languageFormat.getLanguage(31229, 'Please verify the amount that you want to convert and confirm the request:') + "</div><div style='width:100%;text-align:center;padding:10px 0px;font-weight:bold;'><span style='font-size:1.2em;padding-top:10px;'>" + languageFormat.getLanguage(21276, 'Converting') + " "
                + me.comboCurr1.getValue() + " " + me.textCurr1.getValue() + "  </span> <span style='padding-left: 20px;'><img style='vertical-align:middle;' src='images/fxConversion/righticon.png' width='20px'/> </span><span style='padding-left:20px;padding-top:10px;font-size:1.2em;'>" + me.comboCurr2.getValue() + " " + me.textCurr2.getValue() + "</span></div>";
