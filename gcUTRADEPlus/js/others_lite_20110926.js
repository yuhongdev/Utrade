...
function mmLoadMenus(opt,page) {
  ...
  if (opt != "RT") {
  		...
  		if (window.mm_menu_0719160026_0) return;
			...
			/* menu - My Profile */
			window.mm_menu_0719160028_0 = new Menu("root",145,20,"Arial",11,"#000000","#ffffff","#E5E4D7","#3399FF","left","middle",5,0,100,-5,7,true,true,true,0,false,true);
			mm_menu_0719160028_0.addMenuItem("&nbsp;&nbsp;Change Password",     "location='javascript:OpenWinCliChgPwd(\"/gcCIMB/cliChgPasswd.jsp\");'");
			mm_menu_0719160028_0.addMenuItem("&nbsp;&nbsp;Forgot Password",     "location='javascript:OpenWinStlPayStatus();'");
			mm_menu_0719160028_0.addMenuItem("&nbsp;&nbsp;Change Pin",          "location='javascript:OpenWinCliChgPIN(\"/gcCIMB/cliChgPIN.jsp\");'");
			mm_menu_0719160028_0.addMenuItem("&nbsp;&nbsp;Forgot Pin",          "location='javascript:OpenWinCliForgetPIN(\"/gcCIMB/cliForgetPIN.jsp\");'");
			
			/*
			mm_menu_0719160028_0.addMenuItem("&nbsp;&nbsp;SMS Setting",         "location='javascript:OpenWinCliProfiler();'"); 
			mm_menu_0719160028_0.addMenuItem("&nbsp;&nbsp;Account Information", "location='javascript:OpenWinCliAcctInfo();'");
            */
