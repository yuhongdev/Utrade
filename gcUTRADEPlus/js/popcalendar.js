...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "/bursa/img/"			// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	function constructYear() {
		...
		if (!yearConstructed) {
			...
			sHTML += "<tr><td align='center' onmouseover='this.style.backgroundColor=\"#FFCC99\"' onmouseout='clearInterval(intervalID2);this.style.backgroundColor=\"\"' style='cursor:pointer' onmousedown='clearInterval(intervalID2);intervalID2=setInterval(\"incYear()\",30)'	onmouseup='clearInterval(intervalID2)'><img src='http://www.ebrokerconnect.com/img/NSS/drop2.gif'></td></tr>"
