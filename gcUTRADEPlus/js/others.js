...
function mmLoadMenus(opt,page) {
  ...
  if (opt != "RT") {
		  if (window.mm_menu_0719160026_0) return;
			...
			mm_menu_0719160026_0.addMenuItem("&nbsp;&nbsp;English Stock Price",                              "location='/bin/qsee.asp?lang=en'");
			mm_menu_0719160026_0.addMenuItem("&nbsp;&nbsp;&#20013;&#25991;&#21363;&#26102;&#25253;&#20215;", "location='/bin/qsee.asp?lang=CN'");
			/*mm_menu_0719160026_0.addMenuItem("&nbsp;&nbsp;English Futures Price Feed",                       "location='/bin/stkRealTimeFuture.asp?lang=en'");*/
			/*mm_menu_0719160026_0.addMenuItem("&nbsp;&nbsp;&#20013;&#25991;&#34893;&#29983;&#20135;&#21697;", "location='/bin/stkRealTimeFuture.asp?lang=CN'");*/
			/*mm_menu_0719160026_0.addMenuItem("&nbsp;&nbsp;English Stock Price Version 2 (Beta)",                       "location='/bin/qsee.asp'");*/
  		...
  		if (window.mm_menu_0719160026_0) return;
			...
			/* menu - Trading Hall */
			window.mm_menu_0719160026_0 = new Menu("root",155,20,"Arial",11,"#ffffff","#ffffff","#0e3055","#0099cc","left","middle",5,0,100,-5,7,true,true,true,0,false,true);
			mm_menu_0719160026_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>English Stock Price</b>",                              "location='/gcCIMB/applet/qsea.jsp?lang=en'");
			mm_menu_0719160026_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>&#20013;&#25991;&#21363;&#26102;&#25253;&#20215;</b>", "location='/gcCIMB/applet/qsea.jsp?lang=CN'");	
			/*mm_menu_0719160026_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>English Futures Price</b>",                            "location='/gcCIMB/applet/qsda.jsp?lang=en'");*/					
			/*mm_menu_0719160026_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>&#20013;&#25991;&#34893;&#29983;&#20135;&#21697;</b>", "location='/gcCIMB/applet/qsda.jsp?lang=CN'");*/			
			/*if (page == "new")
				mm_menu_0719160026_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>Old Trading Hall</b>",                         "location='/gcCIMB/applet/qsee.jsp?lang=en'");
			else 
				mm_menu_0719160026_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>New Trading Hall</b>",                         "location='/gcCIMB/applet/qsea.jsp?lang=en'");*/					
			
			mm_menu_0719160026_0.hideOnMouseOut=true;
			mm_menu_0719160026_0.bgColor='#0e3055';
			mm_menu_0719160026_0.menuBorder=1;
			mm_menu_0719160026_0.menuLiteBgColor='#0e3055';
			mm_menu_0719160026_0.menuBorderBgColor='#0e3055';
		
			/* menu - Settlement */
			window.mm_menu_0719160027_0 = new Menu("root",145,20,"Arial",11,"#ffffff","#ffffff","#0e3055","#0099cc","left","middle",5,0,100,-5,7,true,true,true,0,false,true);
			mm_menu_0719160027_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>eSettlement</b>",       "location='javascript:OpenWinStlOutstandingCliPos();'");
			mm_menu_0719160027_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>Settlement Status</b>", "location='javascript:OpenWinStlPayStatus();'");
			mm_menu_0719160027_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>eDeposit</b>",          "location='javascript:OpenWinStlDepositStatus();'");
			mm_menu_0719160027_0.hideOnMouseOut=true;
			mm_menu_0719160027_0.bgColor='#0e3055';
			mm_menu_0719160027_0.menuBorder=1;
			mm_menu_0719160027_0.menuLiteBgColor='#0e3055';
			mm_menu_0719160027_0.menuBorderBgColor='#0e3055';
		
			/* menu - My Profile */
			window.mm_menu_0719160028_0 = new Menu("root",145,20,"Arial",11,"#ffffff","#ffffff","#0e3055","#0099cc","left","middle",5,0,100,-5,7,true,true,true,0,false,true);
			mm_menu_0719160028_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>Change Password</b>",     "location='javascript:OpenWinCliChgPwd(\"/gcCIMB/cliChgPasswd.jsp\");'");
			mm_menu_0719160028_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>Forgot Password</b>",     "location='javascript:OpenWinCliForgetPwd(\"/gcCIMB/cliForgetPwd.jsp?secure=Y\");'");
			mm_menu_0719160028_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>Change Pin</b>",          "location='javascript:OpenWinCliChgPIN(\"/gcCIMB/cliChgPIN.jsp\");'");
			mm_menu_0719160028_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>Forgot Pin</b>",          "location='javascript:OpenWinCliForgetPIN(\"/gcCIMB/cliForgetPIN.jsp\");'");
			/*mm_menu_0719160028_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>SMS Setting</b>",         "location='javascript:OpenWinCliProfiler();'");*/
			/*mm_menu_0719160028_0.addMenuItem("<IMG src=/gcCIMB/img/ITRADE-CIMB/button/acc-arrow-itrade.gif />&nbsp;<b>Account Information</b>", "location='javascript:OpenWinCliAcctInfo();'");*/
                        mm_menu_0719160028_0.hideOnMouseOut=true;
			mm_menu_0719160028_0.bgColor='#0e3055';
			mm_menu_0719160028_0.menuBorder=1;
			mm_menu_0719160028_0.menuLiteBgColor='#0e3055';
			mm_menu_0719160028_0.menuBorderBgColor='#0e3055';
...
function OpenWinStlOutstandingCliPos()
{
	...
	window.open('/gcCIMB/stlOutstandingCliPos.jsp', 'winStl', 'left='+ nLeft +',top='+ nTop +',width=780,height=510,location=no,toolbar=no,menubar=no,scrollbars=no,resizable=yes', false)
}
...
//	window.open('/bin/stlDepositStatus.asp', 'winStlDepStatus', 'left='+ nLeft +',top='+ nTop +',width=555,height=530,location=no,toolbar=no,menubar=no,scrollbars=no,resizable=yes', false)
	window.open('/gcCIMB/stlDepositStatus.jsp', 'winStlDepStatus', 'left='+ nLeft +',top='+ nTop +',width=600,height=530,location=no,toolbar=no,menubar=no,scrollbars=no,resizable=yes', false)
}