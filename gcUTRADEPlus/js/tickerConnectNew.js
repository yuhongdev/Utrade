...
function tickerConnectNew(vsObjectID,vsUrl,vsTickerType, vsFontSize, vsWidth, vsSpeed, vsImgUrl) {
	...
	var m_sBgColor = "#000000";  //scroller background, DEFDD9
	var m_sFgColor = "#FFFFFF";var sPadding = "2px";	   //padding for scoller.(0 for non)
	var m_sBorderCSS = "border-top:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC";
		...
		if(sData != ""){
			...
			try {
				...
				if (document.getElementById) {	
					...
					m_iActualWidth  = document.getElementById(m_sScrollerID).innerText.length;
				}
