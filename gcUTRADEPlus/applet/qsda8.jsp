...
try {
	...
	if (m_sLangs.equalsIgnoreCase("en")) {
		...
		sLanguages = "en";
		sFont = "SansSerif";
		cache_archive = "qsd_newCancelRevise.jar,imga.jar,com.ebc.awt.jar,CalcFunc.jar,rbRTBS_en_US.jar,JChart2dN2N.jar";
		cache_version = "1.0.0.17_18,1.0.0.2,1.0.0.1,1.0.0.3,1.0.0.3,1.0.0.1";
	} else {
		...
		cache_archive = "qsd_newCancelRevise.jar,imga.jar,com.ebc.awt.jar,CalcFunc.jar,rbRTBS_en_US.jar,rbRT_zh_CN.jar,JChart2dN2N.jar";
		cache_version = "1.0.0.17_18,1.0.0.2,1.0.0.1,1.0.0.3,1.0.0.3,1.0.0.3,1.0.0.1";
	}
