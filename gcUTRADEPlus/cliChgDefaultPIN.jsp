...
try {
	...
	if (!validSession) {
		...
		if ( (!sOldPIN.equals("")) && (!sNewPIN.equals("")) ) {
			...
			errorMessage = atp.mfChangeExistPIN(g_sCliCode, sLoginID, sOldPIN, sNewPIN, session,g_sDefBHCode);
			...
			<tr><td>
				<table width='100%'>
					...
					<tr><td>&nbsp;</td>
						...
						<td>&nbsp;</td></tr>
					<tr height=25><td>&nbsp;</td>
						<td colspan="2"><input type=submit value='Submit'>&nbsp;&nbsp;<input type="button" name="Cancel" value="CLOSE" onclick="javascript:btnCancel_onClick(getItem('frmChgPIN'));"></td>
						<td>&nbsp;</td></tr></form>
...
function btnCancel_onClick(voFrm) {
