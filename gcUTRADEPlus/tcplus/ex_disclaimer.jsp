...
<%
    String sContent = "";
    String sSponsor = N2NConstant.getConstant("confSponsorID"); //Get exchange
    if (sSponsor != null && !sSponsor.isEmpty()) {
        
        //Have to check for exchange not sponsor
        String sDisclaimerSetting = N2NConstant.getConstant("confExchDisclaimerFile");
