/**
 * @class Ext.app.portal.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Ext.app.portal.PortalPanel}.
 */
Ext.define('Ext.app.portal.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',
    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        Ext.app.portal.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        Ext.app.portal.PortalDropZone.superclass.unreg.call(this);
