        ...
        panel.getStore().filterBy(function (record) {
            ...
            if (panel.filterExtOpt == 0) {
                ...
                if (record.get('ExchangeCode').toUpperCase().indexOf(tempExchangeCode) != -1
                        && record.get('ExchangeCode').toUpperCase().indexOf(mfExcode) == -1) {
                    blnFilterEx = true;
                } else {
                    blnFilterEx = false;
                }
        ...
        var newMenu = [
            {
                ...
                hidden: showV1GUI == "TRUE" || !(showStkInfoHeader == "TRUE" && N2N_CONFIG.features_BrokerQ)
            }, {
                ...
                if (func.name != null) {
                    ...
                    switch (func.name) {
                        ...
                        case panel.cMenuPSEEdgeId:
                            ...
                            btn.setHandler(func.func);
                            break;
                        case panel.cMenuIBId:
                            btn = panel.contextMenu.getComponent(panel.cMenuIBId);
                            btn.setHandler(func.func);
                            break;
                    }
                }
...
//        tempUrl.push(orderDate);
    ...
    currentColumnSetting: function() {
        var currentColumnId = layoutProfileManager.getCol('pf'); // verify from main.jsp
    ...
    requestSaveColumns: function(newColumnId) {
        ...
        colutils.saveColumn('pf', newColumnId);
    ...
    _setCookieId: function() {
        var me = this;
        me.cookieKey = columnWidthSaveManager.getCookieColKey('equityPrtf');
        me.paramKey = N2N_CONFIG.constKey + 'EP';
        me.colWidthKey = 'ep';
    },
