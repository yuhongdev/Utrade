Ext.define('TCPlus.view.orderbook.OrderHistory', {
    ...
    initComponent: function () {
        ...
        for (var ii = 0; ii < global_ExchangeList.length; ii++) {
            if(showMFOrdBookOrderHistory == 'TRUE' && global_ExchangeList[ ii ].exchange == N2N_CONFIG.mfExchCode )
                continue;
    ...
    createContextMenu: function () {
        ...
        if (showStkInfoHeader == "TRUE") {
            ...
            if (N2N_CONFIG.features_BrokerQ) {
                ...
                btns.push({
                    ...
                    handler: function () {
                        n2ncomponents.createBrokerQ({key: orderHistoryPanel.contextMenu.stkCode, name: orderHistoryPanel.contextMenu.stkName});
                    }
                });
            }
        }
        ...
        if (N2N_CONFIG.hasNews2) {
            ...
            btns.push({
                ...
                handler: function() {
                    menuHandler.openNews('', orderHistoryPanel.contextMenu.stkCode);
                }
            });
        }
        ...
        if (N2N_CONFIG.iBillionaireURL.length > 0) {
            ...
            btns.push({
                ...
                handler: function () {
                	n2ncomponents.openIBillionaire(orderHistoryPanel.contextMenu.stkCode);
                }
            });
        }
...
//        panel.to = Ext.get('dtTo').getValue();
    ...
    addNewData: function (newObj, arr, stkEx) {
        ...
        if(showMFOrdBookOrderHistory == 'TRUE' && stkEx == N2N_CONFIG.mfExchCode )
            return;
...
// region start custom column functions
    ...
    currentColumnSetting: function () {
        var currentColumnId = layoutProfileManager.getCol('oh');
    ...
    requestSaveColumns: function(newColumnIdArr) {
        ...
        colutils.saveColumn('oh', newColumnIdArr);
    },
    /**
...
//			returnValue = tempObj.value;
    ...
    _setCookieId: function() {
        var me = this;
        me.cookieKey = columnWidthSaveManager.getCookieColKey('ordHistory');
        me.paramKey = N2N_CONFIG.constKey + 'OH';
        me.colWidthKey = 'oh';
    },
    ...
    runFitScreen: function() {
        ...
        if (!helper.inView(panel)) {
            helper.addBufferedRun('ohFitScreen', function() {
                helper.autoFitColumns(panel);
            });
        } else {
            helper.autoFitColumns(panel);
