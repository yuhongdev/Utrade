        ...
        var defaultConfig = {
            ...
            listeners: {
                ...
                beforedestroy: function(p) {
                    mfOrderHistoryPanel = null;
                    if (!orderStatusPanel || !mfOrderStatusPanel) {
...
//                            btn = this.contextMenu.get(this.menuBrokerQId);
//                            btn.setHandler(func.func);
//                            break;
...
//                      }
                        ...
                        case this.menuNews2Id:
                            btn = this.contextMenu.get(this.menuNews2Id);
                            btn.setHandler(func.func);
                            break;
                        ...
                        case this.menuPSEEdgeId:
                            ...
                            break;
                        case this.menuIBId:
                            btn = this.contextMenu.get(this.menuIBId);
                            btn.setHandler(func.func);
                            break;
                    }
                }
    ...
    createContextMenu: function() {
        ...
        btns.push({
            ...
            popupOnly: true,
            handler: function() {
                var ordRec = mfOrderHistoryPanel.contextMenu.ordRec;
                if (ordRec != null) {
                    ...
                    if ((tktno || ordno) && canCancelRevise(ordsts)) {
                        ...
                        createOrderPad(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName, modeOrdRevise, mfOrderHistoryPanel.contextMenu.ordRec, true);
        ...
        btns.push({
            ...
            handler: function() {
                ...
                if (ordRec != null) {
                    ...
                    if ((tktno || ordno) && canCancelRevise(ordsts)) {
                        closedOrderPad = false;
                        createOrderPad(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName, modeOrdCancel, mfOrderHistoryPanel.contextMenu.ordRec, true);
        ...
        if (showStkInfoHeader == "TRUE") {
            if (showStkInfoMarketDepth == "TRUE") {
                ...
                btns.push({
                    ...
                    handler: function() {
                         ...
                         */
                        closedMarketDepth = false;
                        createMarketDepthPanel(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName, true);
                    }
                });
            }
           ...
           /* if (showStkInfoStkInfo == "TRUE") {*/
                ...
                btns.push({
                    ...
                    handler: function() {
                        createStkInfoPanel(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName, false);
...
//            }
            ...
            /*if (showStkInfoEquitiesTracker == "TRUE") {
                ...
                btns.push({
                    ...
                    handler: function() {
                        n2ncomponents.createEquitiesTracker(mfOrderHistoryPanel.contextMenu.stkCode);
                    }
                });
            }
            ...
            if (N2N_CONFIG.features_HistoricalData) {
                ...
                btns.push({
                    ...
                    handler: function() {
                        n2ncomponents.createHistoricalData(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName);
                    }
                });
            }
            ...
            if (N2N_CONFIG.features_BrokerQ) {
                ...
                btns.push({
                    itemId: menu.menuBrokerQId,
                    text: languageFormat.getLanguage(31800, 'Broker Queue'),
                    handler: function() {
                        n2ncomponents.createBrokerQ({key: mfOrderHistoryPanel.contextMenu.stkCode, name: mfOrderHistoryPanel.contextMenu.stkName});
                    }
                });
            } */
        }
            ...
            if (showChartIntradayChart == "TRUE") {
                ...
                btns.push({
                    ...
                    handler: function() {
                        ...
                        createChartPanel(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName, false);
                    }
                });
            }
            ...
            if (showOrdBookOrderDetails == "TRUE") {
                ...
                btns.push({
                    ...
                    handler: function() {
                         ...
                         * marketMoverPanel.contextMenu.stkCode
                         */
                        var tktno = mfOrderHistoryPanel.contextMenu.ordRec.tktNo;
                        var ordno = mfOrderHistoryPanel.contextMenu.ordRec.ordNo;
                        //var orderDate = mfOrderHistoryPanel.contextMenu.ordRec.ordDate;
                         ...
                         */
                        var orderDate = mfOrderHistoryPanel.contextMenu.ordRec.lastUpdate;
                        var accno = mfOrderHistoryPanel.getAccountValue();
                        ...
                        createOrderDetailPanel(ordno, tktno, mfOrderHistoryPanel.contextMenu.stkName, false, 'ordHistPanel', orderDate, accno);
...
//                         * marketMoverPanel.contextMenu.stkCode
//                         */
//                        createStkNewsPanel(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName);
//                    }
//                });
//            }
...
//                    handler: function() {
//                        n2ncomponents.openArchiveNews({key: mfOrderHistoryPanel.contextMenu.stkCode, name: mfOrderHistoryPanel.contextMenu.stkName});
//                    }
//                });
//            }
...
//                    handler: function() {
//                        n2ncomponents.openElasticNews({key: mfOrderHistoryPanel.contextMenu.stkCode, name: mfOrderHistoryPanel.contextMenu.stkName, newsOpt: '1'});
//                    }
//                });
//            }
...
//                    handler: function() {
//                        n2ncomponents.openElasticNews({key: mfOrderHistoryPanel.contextMenu.stkCode, name: mfOrderHistoryPanel.contextMenu.stkName, newsOpt: '2'});
//                    }
//                });
//            }
//        }
...
//                handler: function() {
//                    menuHandler.openNews('', mfOrderHistoryPanel.contextMenu.stkCode);
//                }
//            });
//        }
...
//                    handler: function() {
//                        createFundamentalCPIQWin(mfOrderHistoryPanel.contextMenu.stkCode);
//                    }
//                });
//            }
//
...
//                         * marketMoverPanel.contextMenu.stkCode
//                         */
//                        createFundamentalThomsonReutersWin(mfOrderHistoryPanel.contextMenu.stkCode);
//                    }
//                });
//            }
//        }
...
//                         * selected StkCode get using
//                         */
//                        n2ncomponents.createAddStockAlert(mfOrderHistoryPanel.contextMenu.stkCode);
//                    }
//                });
//            }
//        }
...
//                     * marketMoverPanel.contextMenu.stkCode
//                     */
//                    createWarrantsInfoWin(mfOrderHistoryPanel.contextMenu.stkCode);
//                }
//            });
//        }
//
...
//                handler: function() {
//                    n2ncomponents.createSMSStockAlert(mfOrderHistoryPanel.contextMenu.stkCode);
//                }
//            });
//        }
//
...
//                handler: function() {
//                    n2ncomponents.openPseEdge(mfOrderHistoryPanel.contextMenu.stkCode);
//                }
//            });
//        }
//
...
//            btns.push({
//                itemId: menu.menuIBId,
//                text: languageFormat.getLanguage(20527, 'Follow iBillionaire'),
//                handler: function() {
//                    n2ncomponents.openIBillionaire(mfOrderHistoryPanel.contextMenu.stkCode);
//                }
//            });
//        }
        } else {
                ...
                if (showStkInfoTracker == "TRUE") {
                    ...
                    btns.push({
                        ...
                        handler: function() {
                             ...
                             * marketMoverPanel.contextMenu.stkCode
                             */
                            createTrackerPanel(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName, false);
                        }
                    });
                }
                ...
                if (showChartAnalysisChart == "TRUE") {
                      ...
                      btns.push({
                          ...
                          handler: function() {
                              ...
                              createAnalysisChartPanel(mfOrderHistoryPanel.contextMenu.stkCode, mfOrderHistoryPanel.contextMenu.stkName, false);
...
//        panel.to = Ext.get('dtTo').getValue();
    ...
    addNewData: function(newObj, arr, stkEx) {
        if (stkEx == N2N_CONFIG.mfExchCode)
            arr.push(newObj);
    },
    ...
    switchRefresh: function() {
        ...
        reactivateRow(panel);
        helper.runBuffer('mfohFitScreen');
    },
    updateFeedRecord: function(dataObj) {
        ...
        /* console.log(" updateFeedRecord -- ");
         ...
         var lacpIndex = colmap.cmap_osLACP;
         var store = this.getStore();
         var datas = obj.d;
         var total = (pagingMode == true) ? store.getTotalCount() : store.getCount();
         ...
         N2NUtil.updateCell(panel, i, lacpIndex, lacp, cssClass);
         }
         }
         }
         }
...
// region start custom column functions
    ...
    requestSaveColumns: function(newColumnIdArr) {
        ...
        colutils.saveColumn('mfoh', newColumnIdArr);
    },
    /**
...
//          returnValue = tempObj.value;
    ...
    getRecordMapping: function() {
        var o = [
            ...
            {name: 'tc', mapping: 'tc', sortType: 'asUCString'},
            ...
            // new col
            {name: 'Amt', mapping: 'Amt', sortType: 'asInt', type: 'int'},
            {name: 'Remark', mapping: 'rmk', sortType: 'asUCString'},
            {name: 'AccountName', mapping: 'accN', sortType: 'asUCString'}
        ];
        return o;
    },
    ...
    _setCookieId: function() {
        var me = this;
        me.cookieKey = columnWidthSaveManager.getCookieColKey('mfOrdHistory');
        me.paramKey = N2N_CONFIG.constKey + 'MFOH';
        me.colWidthKey = 'mfoh';
    },
    ...
    runFitScreen: function() {
        ...
        if (!helper.inView(panel)) {
            helper.addBufferedRun('mfohFitScreen', function() {
                helper.autoFitColumns(panel);
            });
        } else {
            helper.autoFitColumns(panel);
