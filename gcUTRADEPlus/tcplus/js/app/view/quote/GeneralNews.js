...
//    },
    ...
    initComponent: function() {
        ...
        var defaultConfig = {
            ...
            bodyCls: 'font-style-applied font-size-max-applied',
            listeners: {
    ...
    _getNews: function() {
        ...
        Ext.Ajax.request({
            ...
            failure: function(response) {
                panel.tbarMsg.setText(languageFormat.getLanguage(33200, 'Failed to get news from server. Please try again later.'));
                panel.dataView.getEl().update('<div class="x-grid-empty">' + languageFormat.getLanguage(33201, 'Request failed. Please try again.') + '</div>');
                panel.loadMask.hide();
            }
        });
    },
