Ext.define('TCPlus.view.other.PERatioEPSCalculator', {
    ...
    initComponent: function() {
        ...
        Ext.apply(Ext.form.field.VTypes, {
            ...
            sharePrcText: languageFormat.getLanguage(33001, 'Please enter a valid price'),
        ...
        var per_formPanelItems = [
            {
                ...
                alwaysDisplayDecimals: true,
                decimalSeparator: '.',
                labelSeparator: "<div class='pe-help icon-help' title='" + languageFormat.getLanguage(21013, 'P/E Ratio = Price per Share / EPS') + "'></div>",
                fieldStyle: 'text-align:right;',
                ...
                alwaysDisplayDecimals: true,
                decimalSeparator: '.',
                labelSeparator: "<div class='pe-help icon-help' title='" + languageFormat.getLanguage(21014, 'Enhanced P/E Ratio = Price per Share / Enhanced EPS') + "'></div>",
                fieldStyle: 'text-align:right;',
                labelStyle:'font-weight:bold;'	
            }
        ];
        ...
        var eps_formPanelItems = [
            {
                ...
                decimalSeparator: '.',
                //vtype: 'qty',
                labelSeparator: "<div class='pe-help icon-help' title='" + languageFormat.getLanguage(21015, 'EPS = Net Earnings / Outstanding Shares') + "'></div>",
                fieldStyle: 'text-align:right;',
                labelStyle:'font-weight:bold;'	
            },
            {
                ...
                decimalSeparator: '.',
                //vtype: 'qty',
                labelSeparator: "<div class='pe-help icon-help' title='" + languageFormat.getLanguage(21016, 'Enhanced EPS = (Net Earnings + Total Cash) / Outstanding Shares') + "'></div>",
                fieldStyle: 'text-align:right;',
                labelStyle:'font-weight:bold;'	
            }
        ];
