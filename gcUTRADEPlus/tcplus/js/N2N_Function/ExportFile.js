var ExportFile = (function() {
    ...
    function initial(fileType, panel, optCol) {
        ...
        var xTf = new Ext.form.TextField({
                    itemId: "exportCSVTextField",
                    selectOnFocus: true,
        ...
        var btnExport = {
            xtype: "button",
            text: languageFormat.getLanguage(10031, 'Export'),
            tooltip: languageFormat.getLanguage(10031, 'Export'),
            iconCls: 'icon-export-xls',
            handler: function() {
                var fname = expWin.xTf.getValue();
                fname = fname.trim();
