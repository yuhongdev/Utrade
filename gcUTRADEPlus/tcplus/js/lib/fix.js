...
Ext.override(Ext.view.Table, {
    ...
    _lastScrollLeftPosition: null,
    refresh: function() {
        var me = this;
        me.callParent(arguments);
        me.headerCt.el.dom.scrollLeft = me._lastScrollLeftPosition;
        if (N2N_CONFIG.gridBufferedRenderer) {
            ...
            if (me.rendered && me.bufferedRenderer) {
                me.el.dom.scrollTop = me._lastScrollTopPosition;
                me.el.dom.scrollLeft = me._lastScrollLeftPosition;
                me.bufferedRenderer.onViewScroll(null, me.el);
            }

            if (me.selModel && typeof me.selModel.onLastFocusChanged === 'function') {
                me.selModel.onLastFocusChanged(null, me.selModel.lastFocused, true);
            }
        }
    },
    onViewScroll: function(e, t) {
        // to remember scroll position when refresh
        this._lastScrollTopPosition = t.scrollTop;
        this._lastScrollLeftPosition = t.scrollLeft;
        this.headerCt.el.dom.scrollLeft = this._lastScrollLeftPosition;
        return this.callParent(arguments);
    }
});

// remove workaround as it breaks in ff v52.0.2 - sw20170420
//add back workaround as mouse does not work without fix in ff v53 - sw20170421
// fix click/touch not responding on Firefox >= 52
Ext.define('EXTJS_23846.Element', {
    override: 'Ext.dom.Element'
}, function(Element) {
    var supports = Ext.supports;

    if (Ext.isFirefox && Ext.firefoxVersion >= 52 && supports.TouchEvents) {
