...
public String genLoginBody(String vsLoginId1, boolean validSess)	{
	...
	if(!validSess) {
		...
		out.println("			<table border=0 cellPadding=0 cellSpacing=0 width='100%' align=left>");
		out.println("			<tr>");
		out.println("			<td>");

		out.println("    <table border=0 cellpadding=0 cellspacing=0 width='300px'>");
		out.println("        <tr><td width='375px' valign='top'>");
		//Start Login
		out.println("            <table bgcolor=grey  border=0 cellpadding=0 cellspacing=0 width='100%' height=200px>");
		out.println("                <tr>");
		out.println("			<td  valign='middle' colspan=2 align=left>");
		out.println("			<input id=txtLoginID name=txtLoginID value='"+(g_bActReg?g_sID:"")+"' maxlength=15 size=15 autocomplete=off onclick=\"javascript:document.getElementById('txtLoginID').select();\"/>");
		out.println("			</td>");
		out.println("                 </tr>");
		out.println("                <tr>");
		out.println("			<td valign='middle' colspan=2 align=left>");
		out.println("				<input id=txtLoginPwd name=txtLoginPwd type=password value='' maxlength=15 size=15 autocomplete=off onclick=\"javascript:document.getElementById('txtLoginPwd').select();\" />");
		out.println("			</td>");
		out.println("                </tr>");
		out.println("		    <tr>");
		out.println("			<td>");
		...
		out.println("			</td>");
		out.println("		    </tr>");
		out.println("                <tr height=25 valign='top'>");
		out.println("                    <td width='65%'>");
		out.println("                        <a href='javascript:cliForgotPwd_parent()' class='left_content_font' style='text-decoration:none;'>Forgot your password?</a>");
