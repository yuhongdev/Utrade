...
<%
	...
	String atpPort = oN2NSession.getSetting("atpPort")!=null?oN2NSession.getSetting("atpPort").toString():"80";
	com.n2n.util.N2NATPPushConnect atp = new com.n2n.util.N2NATPPushConnect("atpweb");
	com.n2n.connection.LoginContext context = new com.n2n.connection.LoginContext();	
  	...
  	if (sSecure.compareToIgnoreCase("N") == 0) {
  		...
  		out.println("	this.location.href='" + oN2NSession.getSetting("HTMLRoot") + "/gcUTRADEPlus/cliForgetPwd.jsp?secure=Y'");
  		out.println("</script>");
			...
			if (sHint.equals("")) {
    			...
    			if (context.getErrorMsg().equals("")) {
    				...
    				if(sStatus.compareToIgnoreCase("P") == 0) {
    					...
    					nRetCode = -6;
    				} else if (sStatus.compareToIgnoreCase("S") == 0) {
    				    nRetCode = -7;
    			...
    			// context = atp.verifyHintPwdPIN("1", clibean, oN2NSession.getSetting("tradeforgetpinpwdID"), oN2NSession.getSetting("BHCode"));
    			context = atp.verifyHintPwdPIN("1", clibean, session, oN2NSession.getSetting("tradeforgetpinpwdID"), oN2NSession);
				java.util.List resultList = new java.util.ArrayList();
    			String results[] = null;
    			if (context.getErrorMsg().equals("")) {
    				resultList = context.getResultsList();
...
function frmSubmit(voFrm) {
	voFrm.hint.value = ""
	voFrm.hintAns.value = ""
voFrm.action="/gcUTRADEPlus/cliForgetPwd.jsp";
...
<table border=0 cellPadding=0 cellSpacing=0 width=350 height=95%>
	...
	<tr><td>
		<table border=1 style='margin-top:0;' cellpadding=0 cellspacing=0 width='100%' height=100%>
			<tr><td>
				<table border=0 cellpadding=1 cellspacing=1 width='100%'>
					<tr><td width='6%'>&nbsp;</td>
						...
						<td width='3%'>&nbsp;</td></tr>
					<tr><td width='6%'>&nbsp;</td>
						<td width='20%' class=fntInputMsg>User ID</td>
						<td width='74%'>
					...
					<tr><td>&nbsp;</td>
						...
						<td colspan=2><input id=txtHint name=hint class=inputField maxlength=50 size=20 value="<%=sHint%>" readonly/></td>
						<td>&nbsp;</td></tr>
					<tr height=30><td>&nbsp;</td>
...
<%
	switch(nRetCode) {
		case -1:
		    out.print("alert('Your password has been sent to your e-mail account ["+ maskEmail(sEmail) +"]');window.close();");
...
//	  		out.println("	this.location.href='" + oN2NSession.getSetting("HTMLRoot") + g_sPath + "/cliForgetPwd.jsp?secure=C'");
		...
		case -6:
			out.print("alert('Your account not yet been activated, please call CSR.');");
	     	break;
		case -7:
			out.print("alert('Your account was suspended, please call CSR.');");
	     	break;
	    default:
	     	break;
	}
