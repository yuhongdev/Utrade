...
<%
	...
	// added by chuili 20100421 - add bhbranch to Acc **********
	String sBhBranch = (String) request.getParameter("bhbranch");
	sBhBranch = sBhBranch != null ? sBhBranch : "";
	
	if(!selTrdAcc.equals("") && !sBhBranch.equals("")){
		selTrdAcc = selTrdAcc + "-" + sBhBranch;
	}
	//********************************************************
...
<table border=0 cellPadding=0 cellSpacing=0 style='font-family:Arial' width='700'>
<tr><td colspan=3>&nbsp;</td></tr>
<tr><td align=left><font class=Disclaimer_Link>Please be advised that the trust monies shown above are excluding your Multi Currency Trust Account balance (if any).</font></td></tr>
<tr><td align=left><font class=Disclaimer_Link>For further enquires, please check with your dealer's representatives.</font></td></tr>
</table>
