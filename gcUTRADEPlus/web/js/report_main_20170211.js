	...
	if(sttus == "200"){
		...
		if(cliSummArry != null){
			for (var i=0;i<cliSummArry.length;i++){
				var OSPDueFr, OSPNotDueFr, OSPOverdueFr, OSCLFr, OSDNFr, OSIntFr, OSSTo, OSCGTo, OSCNTo, NetBalFr, NetBalTo, exchg;
				exchg = cliSummArry[i].ExChange;
				
				if(cliSummArry[i].ContractDue!=null&&cliSummArry[i].ContractDue!="0.00"){
				...
				if(cliSummArry[i].ContractNotDue!=null&&cliSummArry[i].ContractNotDue!="0.00"){
				...
				if(cliSummArry[i].ContractOverdue!=null&&cliSummArry[i].ContractOverdue!="0.00"){
				...
				if(cliSummArry[i].ContraLoss!=null&&cliSummArry[i].ContraLoss!="0.00"){
				...
				if(cliSummArry[i].DebitNotes!=null&&cliSummArry[i].DebitNotes!="0.00"){
				...
				if(cliSummArry[i].InterestOwing!=null&&cliSummArry[i].InterestOwing!="0.00"){
				...
				if(cliSummArry[i].SalesContract!=null&&cliSummArry[i].SalesContract!="0.00"){
				...
				if(cliSummArry[i].ContraProfit!=null&&cliSummArry[i].ContraProfit!="0.00"){
				...
				if(cliSummArry[i].CreditNotes!=null&&cliSummArry[i].CreditNotes!="0.00"){
				...
				if(cliSummArry[i].NetBalFr!="0.00"){
				...
				rptCliPosSmyRow(OSPDueFr, OSPNotDueFr, OSPOverdueFr, OSCLFr, OSDNFr, OSIntFr, OSSTo, OSCGTo, OSCNTo, NetBalFr, NetBalTo, exchg);
			}
		}
		else{
			console.log("There is no record found");
		...
		var tblTransDate,tblDueDate,tblRefNo,tblStkName,tblPrice,tblQty,tblAmount,tblCurr,tblExchg,tblMyrEquiv,tblMyrInt;
		//cliSummDtlArry
...
function rptCliPosSmyRow(OSPDueFr, OSPNotDueFr, OSPOverdueFr, OSCLFr, OSDNFr, OSIntFr, OSSTo, OSCGTo, OSCNTo, NetBalFr, NetBalTo, exchg){
	...
	tblRow6 = "<tr>";
	tblRow6 += "<td>O/S Interest Owing/ LPC</td>";
	tblRow6 += "<td>"+OSIntFr +"</td>";
	tblRow6 += "<td>&nbsp;</td>";
	tblRow6 += "</tr>";
	...
	tblRow10 += "<td>Net Balance From / Due to You</td>";
	tblRow10 += "<td>"+NetBalFr+"</td>";
	tblRow10 += "<td>"+NetBalTo+"</td>";
	tblRow10 += "</tr>";
	
	if (exchg == "KL"){
		$('#KLsummaryTbl').append(tblRow);
		$('#KLsummaryTbl').append(tblRow2);
		$('#KLsummaryTbl').append(tblRow3);
		$('#KLsummaryTbl').append(tblRow4);
		$('#KLsummaryTbl').append(tblRow5);
		$('#KLsummaryTbl').append(tblRow6);
		$('#KLsummaryTbl').append(tblRow7);
		$('#KLsummaryTbl').append(tblRow8);
		$('#KLsummaryTbl').append(tblRow9);
		$('#KLsummaryTbl').append(tblRow10);
		$('#KLExchg').css("display","");
		$('#KLsummaryTbl').css("display","");
	}
	else if(exchg == "SI"){
		$('#SIsummaryTbl').append(tblRow);
		$('#SIsummaryTbl').append(tblRow2);
		$('#SIsummaryTbl').append(tblRow3);
		$('#SIsummaryTbl').append(tblRow4);
		$('#SIsummaryTbl').append(tblRow5);
		$('#SIsummaryTbl').append(tblRow6);
		$('#SIsummaryTbl').append(tblRow7);
		$('#SIsummaryTbl').append(tblRow8);
		$('#SIsummaryTbl').append(tblRow9);
		$('#SIsummaryTbl').append(tblRow10);
		$('#SIExchg').css("display","");
		$('#SIsummaryTbl').css("display","");
	}
	else if(exchg == "HK"){
		$('#HKsummaryTbl').append(tblRow);
		$('#HKsummaryTbl').append(tblRow2);
		$('#HKsummaryTbl').append(tblRow3);
		$('#HKsummaryTbl').append(tblRow4);
		$('#HKsummaryTbl').append(tblRow5);
		$('#HKsummaryTbl').append(tblRow6);
		$('#HKsummaryTbl').append(tblRow7);
		$('#HKsummaryTbl').append(tblRow8);
		$('#HKsummaryTbl').append(tblRow9);
		$('#HKsummaryTbl').append(tblRow10);
		$('#HKExchg').css("display","");
		$('#HKsummaryTbl').css("display","");
	}
	else if(exchg == "N"){
		$('#NsummaryTbl').append(tblRow);
		$('#NsummaryTbl').append(tblRow2);
		$('#NsummaryTbl').append(tblRow3);
		$('#NsummaryTbl').append(tblRow4);
		$('#NsummaryTbl').append(tblRow5);
		$('#NsummaryTbl').append(tblRow6);
		$('#NsummaryTbl').append(tblRow7);
		$('#NsummaryTbl').append(tblRow8);
		$('#NsummaryTbl').append(tblRow9);
		$('#NsummaryTbl').append(tblRow10);
		$('#NExchg').css("display","");
		$('#NsummaryTbl').css("display","");
	}
	else if(exchg == "AX"){
		$('#AXsummaryTbl').append(tblRow);
		$('#AXsummaryTbl').append(tblRow2);
		$('#AXsummaryTbl').append(tblRow3);
		$('#AXsummaryTbl').append(tblRow4);
		$('#AXsummaryTbl').append(tblRow5);
		$('#AXsummaryTbl').append(tblRow6);
		$('#AXsummaryTbl').append(tblRow7);
		$('#AXsummaryTbl').append(tblRow8);
		$('#AXsummaryTbl').append(tblRow9);
		$('#AXsummaryTbl').append(tblRow10);
		$('#AXExchg').css("display","");
		$('#AXsummaryTbl').css("display","");
	}
	else if(exchg == "JK"){
		$('#JKsummaryTbl').append(tblRow);
		$('#JKsummaryTbl').append(tblRow2);
		$('#JKsummaryTbl').append(tblRow3);
		$('#JKsummaryTbl').append(tblRow4);
		$('#JKsummaryTbl').append(tblRow5);
		$('#JKsummaryTbl').append(tblRow6);
		$('#JKsummaryTbl').append(tblRow7);
		$('#JKsummaryTbl').append(tblRow8);
		$('#JKsummaryTbl').append(tblRow9);
		$('#JKsummaryTbl').append(tblRow10);
		$('#JKExchg').css("display","");
		$('#JKsummaryTbl').css("display","");
	}else{
...
function createTable(tblDocNew){
	...
	rowHeader += "<thead>";
	rowHeader += "<tr>";
	rowHeader += "<td class='tblHeader2' colspan=4 style='background-color:#FFFFFF'></td>";
	...
	rowHeader += "<th>Trans Date</td>";
	rowHeader += "<th>Due Date</td>";
...
function getPDFRpt(rptType){
	var selTrdAcc, frDate, toDate, rptId;
	selTrdAcc = $("#selTrdAcc").val()!=null?$("#selTrdAcc").val():"";
	console.log("selTrdAcc value : "+selTrdAcc);

	//rptId : 2=contract, 3=soa
	if(rptType == "Contract"){ 
		rptId = 2;
		...
		rptId = 3;
		frDate = new Date();
		frDate.setMonth(frDate.getMonth() - 3);
		frDate.setDate(1);
		...
		if (list.length > 0){
			for(var i=0;i<reports.length;i++){
				...
				if(reports[i].fnm == "Contract"){
					...
					filename = "Contract " + reportDt; 
				}
				if(reports[i].fnm == "SOA"){
					reportDt = month + " " + year;
					filename = "Statement of Account " + reportDt;
				}
				$("#tblPdfRpt").append("\
					<tr> \
						<td>" + reportDt + "</td> \
...
function getPDFRptById(rptId, rptName){
	var jsonObject = {};
	jsonObject['rptid'] = rptId;
