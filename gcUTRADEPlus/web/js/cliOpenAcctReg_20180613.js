	...
	var rulesAcc = {
		...
		var rulesPersonalInfo = {   //#tr_dob, #tr_address, #tr_state, #tr_postcode, #tr_country
			...
			frmRegister_yearsWithCompany:{
				...
				digits: {
                		depends: function () {
                    		return $('#frmRegister_employmentStatus').val()=='1';
                		}
            	},
            	validDate: {
                		depends: function () {
                    		return $('#frmRegister_employmentStatus').val()=='2';
                		}
            	}
...
$(document).ready(function(){
	...
	$("#frmRegister_civilStatus2").change(function(){
		if($("#frmRegister_civilStatus2").val()=="SG"){
	...
	$("#frmRegister_employmentStatus").change(function(){
		if($("#frmRegister_employmentStatus").val()=="1"){
			...
			$("#frmRegister_yearsWithCompany").parent().prev().html("Years Established");
	...
	$("input[name=frmRegister_fundSrc]").change(function(){
		if($('input[name=frmRegister_fundSrc]:checked').val() == "6"){
	...
	function calculate(){
		...
		else if(($("#frmRegister_invInstrument").val()=="1")){
			total1++;
		...
		else if(($("#frmRegister_netWorthInv").val()=="1")){
			total1++;
		...
		else if(($("#frmRegister_retireAge").val()=="1")){
			total1++;
		...
		else if(($("#frmRegister_invRedemption").val()=="1")){
			total1++;
		...
		else if(($("#frmRegister_invObj").val()=="1")){
			total1++;
		...
		else if(($("#frmRegister_ratio").val()=="1")){
			total1++;
		...
		else if(($("#frmRegister_invDrop").val()=="1")){
			total1++;
	...
	document.getElementById("frmRegister_mfTotalScore").innerHTML = mfTotalScore;
	}
