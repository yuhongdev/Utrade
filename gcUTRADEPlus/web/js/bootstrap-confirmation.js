 ...
 /* CONFIRMATION PLUGIN DEFINITION
	* ======================= */
	...
	$.fn.confirmation.defaults = $.extend({} , $.fn.tooltip.defaults, {
		...
		, title: 'Skip Schedule?'
		, template: '<div class="popover" id="dtlReminderDiv">' +
				'<div class="arrow"></div>' +
				//'<h3 class="popover-title"></h3>' +
				'<div class="popover-content text-center">Skip for this round schedule?' +
				'</div>'+
				'<div class="popover-content text-center">'+
				'<div class="button">' +
				'<a class="btn btn-small"  onclick="javascript:skipSIP();"></a>' +
				'<a class="btn btn-small" data-dismiss="confirmation" id="cancelDlt"></a>' +
				'</div>' +
				'</div>' +
				'</div>'
		, btnOkClass:  'btn-flat default gray'
		, btnCancelClass:  'btn-flat default gray'
