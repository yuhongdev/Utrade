//register
//added to check session if upgrade account. this will be used to get the login id to be used in the blank username in pdf
	...
	function chkSessResp(data){
		...
		if(data.s&&data.s=="200"){
			...
			var logon = JSON.parse(data.ev);
				if(logon.s=="true"){
					$("#frmRegisterAcc_userID_hidden").val(logon.lid);
					}
				}
	}
...
function registerTrial(){
	...
	if(type=="M"){
		jsonObject['ti'] = $("#frmRegister_title").val();
		jsonObject['clinm'] = $("#frmRegister_cliNameFirst").val() + " " + $("#frmRegister_cliNameMiddle").val() + " " + $("#frmRegister_cliNameLast").val();
...
function registerOpenAcc(){
	...
	if(category != "M"){
		...
		jsonObjectPersonalInfo2['mrt'] = $("#frmRegister_marketRisk").val();
		jsonObjectPersonalInfo2['trdyrs'] = $("#frmRegister_trdYrs").val();
		jsonObjectPersonalInfo2['invexp'] = $("#frmRegister_invInstrument").val();
		jsonObjectPersonalInfo2['nwip'] = $("#frmRegister_netWorthInv").val();
		jsonObjectPersonalInfo2['ra'] = $("#frmRegister_retireAge").val();
		jsonObjectPersonalInfo2['iryrs'] = $("#frmRegister_invRedemption").val();
		jsonObjectPersonalInfo2['lrr'] = $("#frmRegister_ratio").val();
		jsonObjectPersonalInfo2['idrop'] = $("#frmRegister_invDrop").val();
		jsonObjectPersonalInfo2['mfts'] = $("#frmRegister_mfTotalScore").val();
	...
	//changes for 2nd set of beneficiary 09/01/2019
	jsonObjectPersonalInfo['bname2'] = $("#frmRegister_beneficiaryName2").val();
	jsonObjectPersonalInfo['brel2'] = $("#frmRegister_beneficiaryRel2").val();
