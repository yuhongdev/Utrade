...
function registerOpenAcc(){
	...
	jsonObjectPersonalInfo['spnm'] = $("#frmRegister_spouseName").val();
	jsonObjectPersonalInfo['ctz'] = $("#frmRegister_citizenship").val();
	if($("#frmRegister_citizenship").val() == "FP"){
		jsonObjectPersonalInfo['id'] = $("#frmRegister_cli1ICType1").val();
		jsonObjectPersonalInfo['icn'] = $("#frmRegister_cli1ICValue1").val();
		jsonObjectPersonalInfo['idvd'] = $("#frmRegister_idValid").val();
		jsonObjectPersonalInfo['id2'] = $("#frmRegister_cli1ICType2").val();
		jsonObjectPersonalInfo['icn2'] = $("#frmRegister_cli1ICValue2").val();
	}else{
	...
	jsonObjectPersonalInfo['eppc'] = $("#frmRegister_employPostcode").val();
	jsonObjectPersonalInfo['epnum'] = $("#frmRegister_businessNumber").val();
	...
	if(category == "J"){
		...
		if($("#frmRegister_citizenship2").val() == "FP"){
			jsonObjectPersonalInfo2['id'] = $("#frmRegister_cli2ICType1").val();
			jsonObjectPersonalInfo2['icn'] = $("#frmRegister_cli2ICValue1").val();
			jsonObjectPersonalInfo2['id2'] = $("#frmRegister_cli2ICType2").val();
			jsonObjectPersonalInfo2['icn2'] = $("#frmRegister_cli2ICValue2").val();
		}else{
	...
	jsonObject['fds'] = $('input:radio[name=frmRegister_fundSrc]:checked').val()+$("#frmRegister_fundSrcOthers").val();
	...
	jsonObject['mrt'] = $("#frmRegister_marketRisk").val();
	jsonObject['trdyrs'] = $("#frmRegister_trdYrs").val();
	jsonObject['iXp'] = $("#frmRegister_invInstrument").val();
	jsonObject['nwip'] = $("#frmRegister_netWorthInv").val();
	jsonObject['ra'] = $("#frmRegister_retireAge").val();
	jsonObject['iryrs'] = $("#frmRegister_invRedemption").val();
	jsonObject['lrr'] = $("#frmRegister_ratio").val();
	jsonObject['idrop'] = $("#frmRegister_invDrop").val();
	jsonObject['mfts'] = $("#frmRegister_mfTotalScore").val();
	...
	jsonObject['bname'] = $("#frmRegister_beneficiaryName").val();
	jsonObject['brel'] = $("#frmRegister_beneficiaryRel").val();
...
function checkLoginIDResp(data){
	...
	if(data.s&&data.s=="200"){
		...
		if(type ==""){
			$('#frmRegister_userID').removeClass().addClass("valid");
			registerTrial();
		}else{
			$('#frmRegisterAcc_userID').removeClass().addClass("valid");
			chgRegisterLayout(1);
		...
		if(type ==""){			
			setTimeout(function(){
				$('#frmRegister_userID').removeClass().addClass("text-error helper-font-small");
				$('#frmRegister_userID').next().html("Username has already been taken");
				$('#frmRegister_userID').next().show();
			}, 100);			
		}else{
			setTimeout(function(){
				$('#frmRegisterAcc_userID').removeClass().addClass("text-error helper-font-small");
