	...
	if(type=="M"){// individual registration
		...
		var rules_M = {
			...
			frmRegister_cliNameMiddle:{
				//changes made on 12/26/2018 for new cr
				//required:true,
				isRestrict:true,
				maxlength:50
			},		
			...
			frmRegister_telno1:{
				...
				//digits:true,
	            required: function(element) {
	                return $("#frmRegister_mobile1").val() == "";
	            },
				isNumNotReq:true,
				minlength:2,
				maxlength:6
			...
			frmRegister_telno2:{
				...
				//digits:true,
	            required: function(element) {
	                return $("#frmRegister_mobile2").val() == "";
	            },
				isNumNotReq:true,
				minlength:6,
				maxlength:13
...
$(document).ready(function(){
	...
	$("#frmRegister_country").change(function(){
		...
		if ($("#frmRegister_country").val()!="PH") {

			$("#frmRegister_province").parent().parent().hide().blur();
		}
		else{
			$("#frmRegister_province").parent().parent().show();
		}
	});
	$("#frmRegister_hintType").change(function(){
		if($("#frmRegister_hintType").val()=="OTR"){
			$("#frmRegister_hint").parent().parent().show();
		}else{
			$("#frmRegister_hint").parent().parent().hide().blur();
		}
	});
